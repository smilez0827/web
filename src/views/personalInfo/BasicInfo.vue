    ...
    <el-collapse v-model="activeNames">
      <el-form size="small " :inline="true" :model="formData" ref="formData">
        <el-collapse-item name="基本信息">
          ...
          <div>
            <div class="portrait">
              ...
              >
                <img v-if="formData.basicInfo.portrait" :src="formData.basicInfo.portrait" class="avatar" />
              ...
              <el-row>
                ...
                <el-col :span="10">
                  <el-form-item label="出生日期：" prop="date">
                    <el-input v-model="formData.basicInfo.gender" placeholder="请输入出生日期"></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
        ...
        >
          ...
          <el-row>
            <el-col>
              <el-input type="textarea" v-model="item.text" class="text" height="200px"></el-input>
            </el-col>
          </el-row>
        </el-collapse-item>
...
export default {
    ...
    return {
      ...
      formData: {
        ...
        exp: [
          {
            title: "教育经历",
            text: "教育过程开始于一个人的出生并持续终身，对人产生持久而深刻的变化。有些人甚至认为教育可以开始得更早，一些父母通过外部的言语和音乐来影响子宫里成长着的胎儿，进行胎教，希望给孩子以积极的健康的发展。"
          },
          {
            title: "工作经历",
            text: "教育过程开始于一个人的出生并持续终身，对人产生持久而深刻的变化。有些人甚至认为教育可以开始得更早，一些父母通过外部的言语和音乐来影响子宫里成长着的胎儿，进行胎教，希望给孩子以积极的健康的发展。"
  ...
  methods: {
    ...
    handleAvatarSuccess(res, file) {
        this.formData.basicInfo.portrait = URL.createObjectURL(file.raw);
      },
