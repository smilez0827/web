  ...
  <div class="personalInfo">
    ...
    <div class="info">
      ...
      <el-row>
        ...
        <el-col :span="3">
          <!-- <el-link type="success" @click="otherInfo('jiuzhen')">就诊记录</el-link>
        </el-col>
        <el-col :span="3">
          <el-link type="success" @click="otherInfo('zhiliao')">治疗记录</el-link>
        </el-col>
        <el-col :span="3">
          <el-link type="success" @click="otherInfo('ruyuan')">入院记录</el-link> -->
        </el-col>
      </el-row>
    </div>
  </div>
